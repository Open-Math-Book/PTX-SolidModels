      function vrmlViewer(model, parent) {
        var self = this;
        ...
        self.scene.fog = new THREE.Fog( 0x72645b, 1, 6000 );
	...
	*/
      ...
      self.onWindowResize = function () {
        ...
        var w = self.container.clientWidth-4;
        var h = .75*w;
